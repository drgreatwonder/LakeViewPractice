    ...
    <div class="carousel-inner">
      <div class="carousel-item active h-75">
        ...
        <div class="videooverlay">
          ...
          <p>The best of the rest for all things everywhere. The best of the rest for all things everywhere. The best of
            the rest for all things everywhere. The best of the rest for all things everywhere. The best of the rest for
            all things everywhere.
            The best of the rest for aiolpyiolll things everywhere. </p>
          <a class="btn btn-primary btn-lg align-middle" href="" role="button" data-toggle="modal"
            data-target="#elegantModalForm" id="modal">Get Started</a>
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content form-elegant">
        ...
        <div class="modal-header text-center">
          <h3 class="modal-title w-100 dark-grey-text font-weight-bold my-3" id="myModalLabel"><strong>Sign in</strong>
          </h3>
        ...
        <div class="modal-body mx-4">
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="md-form pb-3">
              ...
              <p class="font-small blue-text d-flex justify-content-end">Forgot <a href="fpasswordpage.php"
